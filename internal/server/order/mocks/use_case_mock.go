...
import (
	...
	order_usecase "github.com/Uikola/ybsProductTask/internal/usecase/order_usecase"
)
...
// GetOrders provides a mock function with given fields: ctx, dto
func (_m *MockUseCase) GetOrders(ctx context.Context, dto order_usecase.GetOrdersDTO) ([]entity.Order, error) {
	...
	var r0 []entity.Order
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, order_usecase.GetOrdersDTO) ([]entity.Order, error)); ok {
		return rf(ctx, dto)
	}
	if rf, ok := ret.Get(0).(func(context.Context, order_usecase.GetOrdersDTO) []entity.Order); ok {
		r0 = rf(ctx, dto)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]entity.Order)
	...
	if rf, ok := ret.Get(1).(func(context.Context, order_usecase.GetOrdersDTO) error); ok {
		r1 = rf(ctx, dto)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *MockUseCase_Expecter) GetOrders(ctx interface{}, dto interface{}) *MockUseCase_GetOrders_Call {
	return &MockUseCase_GetOrders_Call{Call: _e.mock.On("GetOrders", ctx, dto)}
}

func (_c *MockUseCase_GetOrders_Call) Run(run func(ctx context.Context, dto order_usecase.GetOrdersDTO)) *MockUseCase_GetOrders_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(order_usecase.GetOrdersDTO))
	})
	return _c
}
...
func (_c *MockUseCase_GetOrders_Call) RunAndReturn(run func(context.Context, order_usecase.GetOrdersDTO) ([]entity.Order, error)) *MockUseCase_GetOrders_Call {
	_c.Call.Return(run)
	return _c
}
